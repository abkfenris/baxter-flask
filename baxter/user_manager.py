...
class RemoveRoleC(RemoveRoleCommand):
	"""
	Removes a role to a user: -u or --user name@server.com, -r or --role role_name
	"""
	pass
class ActivateUserC(ActivateUserCommand):
	"""
	Activates a user: -u or --user name@server.com
	"""
	pass
class DeactivateUserC(DeactivateUserCommand):
	"""
	Deactivates a user: -u or --user name@server.com
	"""
	pass
