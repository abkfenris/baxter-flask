"""added aspect and elevation to snowpit

Revision ID: 555408547c56
Revises: 49a1591fbfd2
Create Date: 2015-01-13 19:38:21.949942

"""

# revision identifiers, used by Alembic.
revision = '555408547c56'
down_revision = '49a1591fbfd2'
...
def upgrade():
    ...
    op.add_column('snowpits', sa.Column('aspect', sa.String(length=40), nullable=True))
    op.add_column('snowpits', sa.Column('elevation', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('snowpits', 'elevation')
    op.drop_column('snowpits', 'aspect')
