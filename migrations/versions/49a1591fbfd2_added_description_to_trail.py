"""added description to trail

Revision ID: 49a1591fbfd2
Revises: d65e4bba002
Create Date: 2015-01-13 19:32:01.895999

"""

# revision identifiers, used by Alembic.
revision = '49a1591fbfd2'
down_revision = 'd65e4bba002'
...
def upgrade():
    ...
    op.add_column('trails', sa.Column('description', sa.Text(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('trails', 'description')
